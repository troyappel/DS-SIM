...
def plot_mapreduce_data_transfer(hist_df, name='mr_data_transfer.png'):
    ...
    plt.plot(t, input, label='Input', drawstyle="steps-post")
    plt.plot(t, shuffle, label='Map to Reduce', drawstyle="steps-post")
    plt.plot(t, output, label='Output', drawstyle="steps-post")
    plt.xlabel("Timestep")
