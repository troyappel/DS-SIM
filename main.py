...
in_memory_history = Simulator(datacenter_mg, tree_pg).run(draw_visualization=True, outfile=outfilename)

# Pull the history object out of the file
reloaded_history = load_history(outfilename)

# Note that reloaded_history and in_memory_history are exactly the same
